...
const SpeechToTextContent = ({ api }) => {
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-gray-50 p-8 h-80 rounded-xl flex flex-col items-center justify-center mb-8 border border-gray-200" style={{ background: 'linear-gradient(180deg, #f0fff0, #f5f5f5)' }}>
        ...
        <p className="mt-2 text-sm text-gray-500">Click to {isRecording ? 'stop and transcribe' : 'start recording'} your voice</p>
      </div>
      ...
      <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-inner">
        <textarea readOnly value={transcription} className="w-full h-32 bg-transparent resize-none focus:outline-none text-gray-800" />
